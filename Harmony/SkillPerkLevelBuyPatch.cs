...
public class SkillPerkLevelBuyPatch
{
    [HarmonyTranspiler]
        ...
        for (int i = 0; i < codes.Count; i++)
        {
            ...
            for (int j = i + 1; j < codes.Count; j++)
            {
                ...
                List<CodeInstruction> replacementInstructions = new()
                {
                    ...
                    new(ReadableOpCodes.CallMethod, AccessTools.PropertyGetter(typeof(XUiC_SkillPerkLevel), nameof(XUiC_SkillPerkLevel.CurrentSkill))),
